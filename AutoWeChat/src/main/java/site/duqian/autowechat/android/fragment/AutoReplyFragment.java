...
public class AutoReplyFragment extends BaseFragment {
    ...
    @BindView(R.id.et_keyword) EditText et_keyword;
    @BindView(R.id.et_reply_content) EditText et_reply_content;
    @BindView(R.id.btn_save_config) Button btn_save_config;
    @BindView(R.id.tv_notify) TextView tv_notify;
